                 ...
                 <!-- DataTales Example -->
                   <div class="col-lg-8 mb-4">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">New Helabiz</h6>
                        </div>
                        <div class="card-body">
...
$title = mysqli_real_escape_string($con,$_POST['title']);
 ...
 if ( strlen($title) < 8 ){
$msg=$msg."Title Must Be More Than 8 Char Length.<BR>";
$status= "NOTOK";}
 if ( strlen($body) < 8 ){
$msg=$msg."Helabiz detail Must Be More Than 8 Char Length.<BR>";
$status= "NOTOK";}
/*$uploads_dir = 'uploads';
...
if($status=="OK")
{
$qb=mysqli_query($con,"INSERT INTO helabiz (user_id, title, body) VALUES ('$user_id', '$title',  '$body')");
...
<div class='alert alert-success'>
                    ...
                    <i class='fa fa-ban-circle'></i><strong>Success : </br></strong>Helabiz Submitted Succefully. Goodluck!.</div>"; //printing error if found in validation
   ...
   ?>
			...
			?>
                  ...
                  <input type="text" class="form-control" name="title" placeholder="Subject">
                   ...
                   <div>
                              <label>Helabiz Details</label>
                  <textarea class="textarea ckeditor" id="body" name="body" placeholder="Message"
