...
<head>
  ...
  <title>EarnPro Agencies | SmartQuiz</title>
...
<body>
  ...
  <main class="content">
    ...
    <p>The SmartQuiz feature is currently disabled, You will be notified once its back.</p>

<button style="background-color: #3c8dbc;
border-color: #367fa9; color:#FFF;" ><a href="dashboard.php">Go Home</a></button>
  </main>
