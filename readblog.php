...
while($row = mysqli_fetch_array($result))
{
	...
	$postdate="$row[postdate]";
        $postdate= $date= date("l jS \of F Y h:i:s A", strtotime($postdate));
              ...
              <div class="u-align-center u-container-style u-expanded-width u-group u-video-cover u-group-2">
                <div class="u-container-layout u-container-layout-4"><!--blog_post_header-->
                  ...
                  <div class="u-blog-control u-metadata u-text-grey-30 u-metadata-2"><!--blog_post_metadata_date-->
                      <span class="u-meta-date u-meta-icon"><!--blog_post_metadata_date_content-->Posted by <b><?php print $user_id ?></b> on <?php print $postdate ?> | <b>Category:</b> <?php print $category ?><!--/blog_post_metadata_date_content--></span><!--/blog_post_metadata_date-->
                  </div><!--/blog_post_metadata--><!--blog_post_content-->
                  <hr>
                  <div class="u-blog-control u-post-content u-text u-text-default u-text-5"><!--blog_post_content_content--><?php print $details ?><!--/blog_post_content_content--></div><!--/blog_post_content-->
                  <hr>
                  <div class="fb-comments" data-href="readblog.php?id=$id" data-width="" data-numposts="5"></div>
                </div>
              </div>
            </div>
          </div>
