            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success portlet-item">
                  <header class="panel-heading"> Ads Details |  <a href='deleteads.php?id=$id'>Delete Ads</a> </header>
                ...
                <table class="table table-striped m-b-none" data-ride="datatables">
                    <?php 
					 $query="SELECT * FROM  advert where id='$toupdate' "; 
