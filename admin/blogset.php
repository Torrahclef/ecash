            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success portlet-item">
                  <header class="panel-heading"> Blog Settings </header>
                  <section class="panel panel-default">
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">Blog Status</a></li>
                ...
                <table class="table table-striped m-b-none" data-ride="datatables">
                  <thead>
                    <tr>
                      ...
                      <th width="50%">Blog Status</th>
					  <th width="50%">Action</th>
                    </tr>
                  </thead>
                  <tbody>
				  <?php 
				   $q="SELECT blog_status FROM  settings"; 
...
while($ro = mysqli_fetch_array($r123))
{
  ...
  print "<tr>
	...
	{
	print "<a href='disableblog.php' class='btn btn-info btn-sm'>Disable</a>";
	}
	if($blog_status=="Disabled")
	{
	print "<a href='enableblog.php' class='btn btn-success btn-sm'>Enable</a>";
	}
