            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success ">
                  <header class="panel-heading"> Submitted Helabiz </header>
                  <section class="panel panel-default">
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">Submitted Helabiz</a></li>
                ...
                <table class="table table-striped m-b-none" data-ride="datatables">
                  <thead>
                    <tr>
					  ...
					  <th width="15%">Veiws</th>
					  <th width="30%">Action</th>
                    </tr>
                  </thead>
                  <tbody>
				  <?php 
				   $q="SELECT * FROM helabiz where pay=1 ORDER BY view DESC"; 
...
while($ro = mysqli_fetch_array($r123))
{
  ...
  print "<tr>
	...
	if($pay=="Unpaid")
	{
	print "<a href='payhela.php?id=$id' class='btn btn-danger btn-sm'>Unpaid</a>";
	}
	if($pay=="Paid")
	{
	print "<span class='btn btn-success btn-sm'>Paid</span>";
	}
