  ...
  <section>
    ...
    <?php include'aside.php'; ?>
      ...
      <section id="content">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success portlet-item">
                  <header class="panel-heading"> Generate Pin </header>
                  <section class="panel panel-default">
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">New Pin</a></li>
		...
		$query = mysqli_query($con,"INSERT INTO `pin` (pin_code) VALUES ('$pin_code')");
		
		
		if($query){
		    	
			echo "<script>alert('Pin Code Saved!')</script>";
			echo "<script>window.location = 'gen_pin.php'</script>";
		}else{
...
?>
					  <div class="form-group">
                        ...
                        <input name="pin_code" class="form-control" value="<?php echo coupon(15); ?>" required="">
                      </div>
                             
                                        <button type="submit" name="save" class="btn btn-lg btn-primary btn-block">Submit Pin</button>
                    </form>
                      </div>
