...
$blog_status = mysqli_real_escape_string($con,$_POST['blog_status']);
...
if($status=="OK")
{
$res1=mysqli_query($con,"update settings set header='$hdrtext', footer='$ftrtext', wlink='$wlink',coname='$coname',invoicedetails='$codetail',email='$coemail',fblink='$fb',twitterlink='$tw',paypalid='$payemail', maintain='$maintain' ,blog_status='$blog_status', alwdpayment='$alwdpayment', payzaid='$payzaid', solidtrustid='$solidid', solidbutton='$solidbutton' where sno='$sno'");
