            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success">
                  <header class="panel-heading"> Users Registered Today</header>
                  <section class="panel panel-default">
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">Users Registered Today</a></li>
...
border-style: dashed;
  ...
  <?php
  $curdate=date("Y-m-d");
  $query="SELECT * FROM  affiliateuser where level=2 AND doj='$curdate' ORDER BY id DESC"; 
