            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success ">
                  <header class="panel-heading"> Pending Articles </header>
                  <section class="panel panel-default">
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">Pending Articles</a></li>
              ...
              <div class="table-responsive">
                <table class="table table-striped m-b-none" data-ride="datatables">
                  ...
                  <tbody>
				  <?php 
				   $q="SELECT * FROM  article WHERE status >1 ORDER BY id DESC"; 
...
while($ro = mysqli_fetch_array($r123))
{
  ...
  print "<tr>
				...
				$user_id
				  ...
				  <td>
				  <a href='deleteart.php?id=$id' class='btn btn-danger btn-sm'>Delete</a> 
				        <a href='view_art.php?id=$id' class='btn btn-default btn-sm'>View</a> 
				  ";
				  
				
	if($status=="Pending")
	{
	print "<a href='deactivateart.php?id=$id' class='btn btn-info btn-sm'>Reject</a>";
	}
         if($status=="Pending")
	{
	print "<a href='activateart.php?id=$id' class='btn btn-success btn-sm'>Approve</a>";
	}
