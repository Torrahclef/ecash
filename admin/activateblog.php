...
$query2 = "SELECT * FROM blog where id = '$tomake'"; 
$pointcalla = mysqli_query($con,$query2 ); 
 ...
 $prevtamount =$row['tamount']+$blog_bonus;
 

$result=mysqli_query($con,"UPDATE blog SET status=1 WHERE id='$tomake'");
$res11=mysqli_query($con,"update affiliateuser set tamount = $prevtamount where username='$tt'");
$res12=mysqli_query($con,"INSERT INTO transaction (username, paidfor, amount, date) VALUES ('$tt', 'Blog Bonus', '$blog_bonus', NOW() )");
if ($result && $res11)
{
print "<center>Blog Approved Successfully<br/>Redirecting in 2 seconds...</center>";
}
else
{
