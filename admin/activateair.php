<?php
header( "refresh:3;url=airtime.php" );
...
$query2 = "SELECT * FROM airtime where id = '$tomake'"; 
...
$result=mysqli_query($con,"UPDATE airtime SET status=1 WHERE id='$tomake'");
if ($result)
{
print "<center>Airtime Sent<br/>Redirecting in 2 seconds...</center>";
}
else
{
