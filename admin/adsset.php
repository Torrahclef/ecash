            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success portlet-item">
                  <header class="panel-heading"> Adverts Setting </header>
                  <section class="panel panel-default">
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">Ads Status</a></li>
              ...
              <div class="table-responsive">
                <table class="table table-striped m-b-none" data-ride="datatables">
                  ...
                  <tbody>
				  <?php 
				   $q="SELECT ads_status FROM  settings"; 
...
while($ro = mysqli_fetch_array($r123))
{
  ...
  print "<tr>
	...
	{
	print "<a href='disableads.php' class='btn btn-info btn-sm'>Disable</a>";
	}
	if($ads_status=="Disabled")
	{
	print "<a href='enableads.php' class='btn btn-success btn-sm'>Enable</a>";
	}
