                ...
                <section class="panel panel-success portlet-item">
                  ...
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      ...
                      <li><a href="#profile" data-toggle="tab">Delete Category</a></li>
                  ...
                  <div class="panel-body">
                    <div class="tab-content">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Maximum 20 Words" name="cat_name">
                      </div>
                      
			
                     <button type="submit" class="btn btn-lg btn-primary btn-block">Add Category</button>
                    </form>
                  </div>
					  
					  </div>
                      <div class="tab-pane" id="profile"><form action="deletecat.php" method="post">
                      <div class="form-group">
                        <label>
...
while($row = mysqli_fetch_array($result))
{
  ...
  print "<option value='$id'>$cat_name</option>";
