            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success portlet-item">
                  <header class="panel-heading"> non-active Users Settings </header>
                  <section class="panel panel-default">
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">non-active Users</a></li>
...
border-style: dashed;
    ...
    <input id='myInput' class="some" onkeyup='searchTable()' Placeholder="Search for user" type='text'>
                <table class="table table-striped b-t b-light"  id="myTable">
                  ...
                  <tbody>
				  <?php $query="SELECT * FROM  affiliateuser where level=2 AND active=0 OR launch=0 ORDER BY id DESC"; 
