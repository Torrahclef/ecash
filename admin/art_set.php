...
<head>
<meta charset="utf-8" />
<title>Article Module Setting</title>
            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success">
                  <header class="panel-heading"> Article Settings </header>
                  <section class="panel panel-default">
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">Article Status</a></li>
                ...
                <table class="table table-striped m-b-none" data-ride="datatables">
                  <thead>
                    <tr>
                      ...
                      <th width="50%">Article Status</th>
					  <th width="50%">Action</th>
                    </tr>
                  </thead>
                  <tbody>
				  <?php 
				   $q="SELECT art_status FROM  settings"; 
...
while($ro = mysqli_fetch_array($r123))
{
	...
	$art_status="$ro[art_status]";
        
	if($art_status==1)
	{
	$art_status="Enabled";
	}
	else if($art_status==0)
	{
	$art_status="Disabled";
	}
	else
  ...
  print "<tr>
	...
	if($art_status=="Enabled")
	{
	print "<a href='disableart.php' class='btn btn-info btn-sm'>Disable</a>";
	}
	if($art_status=="Disabled")
	{
	print "<a href='enableart.php' class='btn btn-success btn-sm'>Enable</a>";
	}
