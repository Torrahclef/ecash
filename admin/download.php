                ...
                <section class="panel panel-success portlet-item">
                  ...
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">Upload New Material</a></li>
...
if($status=="OK"){
		$query = mysqli_query($con,"INSERT INTO `download` (title, ufile) VALUES ('$title', '$new_file_name')");
		
		
		if($query){
		    	
			echo "<script>alert('File Uploaded Successfully!')</script>";
			echo "<script>window.location = 'download.php'</script>";
		}else{
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   ?>
					...
					<input type="hidden" name="todo" value="post">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Material Title/ Name" required>
                      </div>     
                  ...
                  <button type="submit" name="save" class="btn btn-lg btn-primary btn-block">Submit Article</button>
                    </form>
					  </div>
