            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success">
                  <header class="panel-heading"> Uploaded Files</header>
                  <section class="panel panel-default">
                  <header class="panel-heading bg-light">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active"><a href="#home" data-toggle="tab">Uploaded Materials</a></li>
                ...
                <table class="table table-striped m-b-none" data-ride="datatables">
                  <thead>
                    <tr>
					  ...
					  <th width="35%">Upload Date</th>
					  <th width="30%">Action</th>
                    </tr>
                  </thead>
                  <tbody>
				  <?php 
				   $q="SELECT * FROM  download ORDER BY id DESC"; 
...
while($ro = mysqli_fetch_array($r123))
{
  ...
  print "<tr>
				  ...
				  <td>
				 <a href='$url/admin/uploads/$ufile'>  $title</a>
				  </td>
				  <td>
				$date
				  </td>
				  ...
				  <td>
				  <a href='deletefile.php?id=$id' class='btn btn-danger btn-sm'>Delete</a> 
				 ";
