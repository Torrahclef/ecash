...
$toupdate =  mysqli_real_escape_string($con,$_GET['mobile']);
?>
<!DOCTYPE html>
            ...
            <div class="row">
              ...
              <div class="col-sm-12 portlet">
                <section class="panel panel-success portlet-item">
                       <?php 
					 $query="SELECT * FROM  affiliateuser where mobile='$toupdate' "; 
                  ...
                  <div class="panel-body">
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" value="<?php print $username ?>" class="form-control" placeholder="Enter Username" name="us" disabled>
                      </div>
					  
                       
                        <input type="hidden" value="<?php print $username ?>" class="form-control" placeholder="Enter Username" name="username">
					  ...
					  <div class="form-group">
						...
						<div class="form-group">
                        <label>Mobile</label>
                        <input type="text" value="<?php print $mobile ?>" class="form-control" placeholder="Enter mobile" name="mobile" >
                      </div>
