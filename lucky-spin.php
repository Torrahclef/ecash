                   ...
                   <div class="col-lg-8 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Welcome Spin</h6>
                                </div>
                            
                         
                           
                              <div class="card-body">
                              <h6> <span class="card-subtitle"> User Balance:</span>Ksh. <strong id="user_balance">
                                  ...
                                  <td>
                                    <form wire:submit.prevent="validateAmount">
                                      <div class="input-group mb-0 p-r-4">
                                        <input type="text" id="amount" name="amount" class="form-control" value="20" style="background:none !important" maxlength="4" size="4">
   ...
   <script type="text/javascript" src="spin/js/Winwheel.min.js"></script>
                    ...
                    <script>
                      ...
                      function resetWheel() {
                        ...
                        document.getElementById('user_balance').innerHTML=balance;
                      }
