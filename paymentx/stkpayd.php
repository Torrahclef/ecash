  ...
  <body>
    ...
    <section id="home" class="banner">
      ...
      <div class="contact-form">
        ...
        <form action="mpesa_pay.php" method="post"  onsubmit="return myFunction();">
          ...
          <p>Phone Number</p><input type="text" name="phone" value="<?php echo $mobile ?>" required>

          <p>Amount</p><input type="number" name="amount" value="500" required>
          <input type="submit" name="submit" value="Pay">
          <p> You will receive an mpesa pop up.<br>
            Enter your pin to complete payment</p>
          <div id="loadSpin"></div>
    ...
    <script>
      function myFunction() {
        ...
        if (arr1.indexOf(name1) == -1) {
          element1.className += " " + name1;
          element1.innerHTML = "<h6> Please Wait...</h6>";
        }
      }
    </script>
